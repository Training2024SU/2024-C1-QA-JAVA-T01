...
public class ConstantesMenu {
    ...
    static String CUARTO_MENSAJE_GUARDAR_LIBRO = "Por favor ingrese la cantidad de libros prestados";
    static String QUINTO_MENSAJE_GUARDAR_LIBRO = "Por favor ingrese la cantidad disponible del libro";
    static String SEXTO_MENSAJE_GUARDAR_LIBRO = "Por favor ingrese el area del conocimiento del libro";
    static String SEPTIMO_MENSAJE_GUARDAR_LIBRO = "Por favor ingrese el numero de paginas del libro";
    public static String OCTAVO_MENSAJE_GUARDAR_LIBRO = "Se ha guardado el libro exitosamente";
    public static String NOVENO_MENSAJE_MODIFICAR_LIBRO = "Se ha modificado el libro exitosamente";
    ...
    static String CUARTO_MENSAJE_GUARDAR_NOVELA = "Por favor ingrese la cantidad de novelas prestadas";
    static String QUINTO_MENSAJE_GUARDAR_NOVELA = "Por favor ingrese la cantidad disponible de novelas";
    static String SEXTO_MENSAJE_GUARDAR_NOVELA= "Por favor ingrese el genero de la novela";
